  ...
  return (
    <Fragment>
      {loading ? (
        ...
        <Fragment>
          <MetaData title={"Buy Best Fashions online"} />
          {ishome && (
            <Banner
              src="https://res.cloudinary.com/dyj5kbgai/image/upload/c_crop/v1681800772/4028484_uegobn.jpg"
              search="true"
              text="Enjoy Your Fashion With The Best Quality"
              text2="Get your fashion items delivered at your shopsteps all day everyday"
            />
          )}
